...
menu3 = f'''
    ...
    {color.WHITE}34. {color.GREEN}Dump All Contacts           {color.WHITE}39. {color.GREEN}Update Alpha-pro-Pro              {color.WHITE}    {color.GREEN}
    {color.WHITE}35. {color.GREEN}Dump Call Logs              {color.WHITE}40. {color.GREEN}Visit Alpha-pro-Pro on GitHub     {color.WHITE}    {color.GREEN}
...
{color.RED}[Alpha]   {color.WHITE}Press 'Enter' to continue attack / '0' to Go Back to Main Menu
    '''
