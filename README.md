# Alpha
### Alpha-pro with Metasploit Integration.
![GitHub release (latest by date)](https://img.shields.io/github/v/release/AzeemIdrisi/Alpha-pro-Pro)
[![CodeFactor](https://www.codefactor.io/repository/github/azeemidrisi/Alpha-pro-pro/badge)](https://www.codefactor.io/repository/github/azeemidrisi/Alpha-pro-pro)
![Python](https://img.shields.io/badge/python-v3.10%2B-blue)
![GitHub Release Date](https://img.shields.io/github/release-date/AzeemIdrisi/Alpha-pro-Pro?logo=github)
![GitHub last commit](https://img.shields.io/github/last-commit/AzeemIdrisi/Alpha-pro-Pro?logo=github)
![GitHub Repo stars](https://img.shields.io/github/stars/AzeemIdrisi/Alpha-pro-Pro?style=social)
![GitHub forks](https://img.shields.io/github/forks/AzeemIdrisi/Alpha-pro-Pro?style=social)
...
The goal of this project is to make penetration testing on Android devices easy. Now you don't have to learn commands and arguments, Alpha does it for you. Using this tool, you can test the security of your Android devices easily.

> __Alpha__ can also be used as a complete ADB Toolkit to perform various operations on Android devices over Wi-Fi as well as USB. 
...
__Alpha__ does not need any installation and runs directly using `python3`

#### On Linux / macOS :

Make sure all the [required](https://github.com/AzeemIdrisi/Alpha-pro-Pro#requirements) software are installed.

Open terminal and paste the following commands : 
```
git clone https://github.com/AzeemIdrisi/Alpha-pro-Pro.git
```
```
cd Alpha-pro-Pro/
```
```
python3 Alpha-propro.py
```
#### On Windows :
...
2. Copy all files from the extracted `platform-tools` or `adb` directory to __Alpha-pro-Pro__ directory and then run :

```
python Alpha-propro.py
```
...
10. Run __Alpha__ and select `Connect a device` and enter the target's `IP Address` to connect over Wi-Fi.
...
2. Run __Alpha__ and select `Connect a device` and enter the target's `IP Address` to connect over Wi-Fi.
...
All the new features are primarily tested on **Linux**, thus **Linux** is recommended for running Alpha.
...
**On Windows** : Copy all the files from the extracted **scrcpy** folder to **Alpha-pro-Pro** folder.
...
<a href="https://github.com/azeemidrisi/">
  <img src="https://contrib.rocks/image?repo=azeemidrisi/Alpha-pro-pro" />
</a>
