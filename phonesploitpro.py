...
def check_packages():
    ...
    if adb_status != 0 or metasploit_status != 0 or scrcpy_status != 0:
        ...
        choice = input(
            f'\n{color.GREEN}Do you still want to continue to Alpha?{color.WHITE}     Y / N > ').lower()
...
def exit_Alpha-pro_pro():
    global run_Alpha-pro_pro
    run_Alpha-pro_pro = False
    print("\nExiting...\n")
...
def get_screenshot():
    ...
    if screenshot_location == "":
        ...
        print(
            f"\n{color.PURPLE}Saving screenshot to Alpha-pro-Pro/{screenshot_location}\n{color.WHITE}")
    else:
        print(
...
def screenrecord():
    ...
    if screenrecord_location == "":
        ...
        print(
            f"\n{color.PURPLE}Saving video to Alpha-pro-Pro/{screenrecord_location}\n{color.WHITE}")
    else:
        print(
...
# Checking if specified file or folder exists in Android
    ...
    if pull_location == "":
        ...
        print(
            f"\n{color.PURPLE}Saving file to Alpha-pro-Pro/{pull_location}\n{color.WHITE}")
    else:
...
def copy_whatsapp():
    ...
    if pull_location == "":
        pull_location = 'Downloaded-Files'
        print(
            f"\n{color.PURPLE}Saving data to Alpha-pro-Pro/{pull_location}\n{color.WHITE}")
    else:
...
def copy_screenshots():
    ...
    if pull_location == "":
        pull_location = 'Downloaded-Files'
        print(
            f"\n{color.PURPLE}Saving Screenshots to Alpha-pro-Pro/{pull_location}\n{color.WHITE}")
    else:
        print(
...
def copy_camera():
    ...
    if pull_location == "":
        pull_location = 'Downloaded-Files'
        print(
            f"\n{color.PURPLE}Saving Photos to Alpha-pro-Pro/{pull_location}\n{color.WHITE}")
    else:
...
def dump_sms():
    ...
    if pull_location == "":
        pull_location = 'Downloaded-Files'
        print(
            f"\n{color.PURPLE}Saving SMS file to Alpha-pro-Pro/{pull_location}\n{color.WHITE}")
    else:
...
def dump_contacts():
    ...
    if pull_location == "":
        pull_location = 'Downloaded-Files'
        print(
            f"\n{color.PURPLE}Saving Contacts file to Alpha-pro-Pro/{pull_location}\n{color.WHITE}")
    else:
        print(
...
def dump_call_logs():
    ...
    if pull_location == "":
        pull_location = 'Downloaded-Files'
        print(
            f"\n{color.PURPLE}Saving Call Logs file to Alpha-pro-Pro/{pull_location}\n{color.WHITE}")
    else:
        print(
...
def extract_apk():
    ...
    if package_name == '':
        ...
        if pull_location == "":
            pull_location = 'Downloaded-Files'
            print(
                f"\n{color.PURPLE}Saving APK file to Alpha-pro-Pro/{pull_location}\n{color.WHITE}")
        else:
            print(
...
def update_me():
    print(f'{color.YELLOW}\nUpdating Alpha-pro-Pro\n{color.WHITE}')
    print(f'{color.GREEN}Fetching latest updates from GitHub\n{color.WHITE}')
    os.system('git fetch')
    print(f'{color.GREEN}\nApplying changes\n{color.WHITE}')
    os.system('git rebase')
    print(f'{color.CYAN}\nPlease restart Alpha-pro-Pro{color.WHITE}')
    exit_Alpha-pro_pro()


def visit_me():
    os.system(f'{opener} https://github.com/AzeemIdrisi/Alpha-pro-Pro')
    print("\n")
...
if run_Alpha-pro_pro:
    clear_screen()
    while run_Alpha-pro_pro:
        try:
            main()
